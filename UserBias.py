    ...
    def bias(self):
        ...
        with open(self.ItemKNN_file) as ikf, open(self.Biased_MF_file) as bmf,\
            ...
            for line1, line2, line3, line4, line5 in zip(ikf, bmf, ukf, rsf, bf):
                ...
                # print origin_rating,predict
                if pre_user == -1: pre_user = userid 
                if pre_user != userid:
                    print pre_user, original_sum/total, predict_sum/total, predict_sum/total - original_sum/total
                    pre_user, original_sum, predict_sum, total = userid,float(origin_rating),predict,1
                    continue
