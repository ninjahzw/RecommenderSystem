...
class Compair:
    ...
    def origin(self, file_path):
        ...
        print MAE, RMSE
print 'BiasedMF'
Compair().origin("/disk/hou/workspace/RecommenderSystem/librec-1m/result/predicts.BiasedMF")
print 'RegSVD'
Compair().origin("/disk/hou/workspace/RecommenderSystem/librec-1m/result/predicts.RegSVD")
print 'BPMF'
Compair().origin("/disk/hou/workspace/RecommenderSystem/librec-1m/result/predicts.BPMF")
print 'ItemKNN'
Compair().origin("/disk/hou/workspace/RecommenderSystem/librec-1m/result/predicts.ItemKNN")
print 'UserKNN'
Compair().origin("/disk/hou/workspace/RecommenderSystem/librec-1m/result/predicts.UserKNN")
#Compair().compair()
